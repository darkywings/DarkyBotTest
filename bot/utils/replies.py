...
class Replies:
    ...
    WITLESS_GENERATE_FAIL = (
        ...
        "Это обычно связано с тем, что я собрала недостаточно данных для генерации, либо же вам просто не повезло и вы можете повторить попытку.\n"
